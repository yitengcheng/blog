...
.dragon .body {
  ...
  width: 180px;
  height: 128px;
  background: url(../../../static/dragon-img/body.png) no-repeat center center;
...
.dragon .horn-left {
  ...
  width: 31px;
  height: 31px;
  background: url(../../../static/dragon-img/horn-left.png) no-repeat;
  background-size: contain;
  z-index: 9;
...
.dragon .horn-right {
  ...
  width: 34px;
  height: 31px;
  background: url(../../../static/dragon-img/horn-right.png) no-repeat;
  background-size: contain;
  z-index: 9;
...
.dragon .eye {
  ...
  width: 11px;
  height: 11px;
  background: url(../../../static/dragon-img/eye.png) no-repeat;
  background-size: contain;
  z-index: 12;
}
.dragon .eye.left {
...
.dragon .blush {
  ...
  width: 15px;
  height: 9px;
  background: url(../../../static/dragon-img/blush.png) no-repeat;
...
.dragon .mouth {
  ...
  width: 78px;
  height: 56px;
  background: url(../../../static/dragon-img/mouth.png) no-repeat;
  background-size: 100%;
  z-index: 11;
...
.dragon .tail-sting {
  ...
  width: 40px;
  height: 38px;
  background: url(../../../static/dragon-img/tail-sting.png) no-repeat;
  background-size: contain;
  z-index: 9;
...
.fire {
  ...
  width: 100%;
  height: 100%;
  background: url(../../../static/dragon-img/fire.png) no-repeat;
  background-size: contain;
